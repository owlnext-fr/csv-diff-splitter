...
pub fn validate_source_file(source_path: &Path) {
    if !source_path.exists() || !source_path.is_file() {
        crate::crash!(
            ...
            error_codes::ERROR_SOURCE_FILE_NOT_FOUND
        );
    }
...
pub fn validate_target_file(target_path: &Path) {
    if !target_path.exists() || !target_path.is_file() {
        crate::crash!(
            ...
            error_codes::ERROR_TARGET_FILE_NOT_FOUND
        );
    }
...
pub fn validate_config_file(config_file: &Path) {
    if !config_file.exists() || !config_file.is_file() {
        crate::crash!(
            ...
            error_codes::ERROR_CONFIG_FILE_NOT_FOUND
        );
    }
...
pub fn validate_output_path(output_path: &Path) {
    if !output_path.exists() || !output_path.is_dir() {
        crate::crash!(
            ...
            error_codes::ERROR_OUTPUT_PATH_NOT_FOUND
        );
    }
